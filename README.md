...
Seru seruan hacktoberfest 2019 di Kopinema :checkered_flag:
...
### Clone Project
```
git clone https://github.com/{ user name kamu }/grindingHacktoberFest2019.git

cd grindingHacktoberFest2019
```
